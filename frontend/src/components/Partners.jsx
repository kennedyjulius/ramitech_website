    ...
    <div className="bg-gray-50 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="grid grid-cols-10 gap-4 rotate-12 scale-150 opacity-20">
          {Array(100).fill(0).map((_, i) => (
            <div key={i} className="h-8 bg-emerald-400/20 rounded-full animate-pulse" style={{ animationDelay: `${i * 0.1}s` }} />
          ))}
        </div>
      </div>
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <div className="w-20 h-1 bg-emerald-400 mx-auto animate-[slideUp_1s_ease-out] delay-200"></div>
        </div>
              ...
              {partners.map((partner, index) => (
                ...
                >
                  <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 group">
                    <div className="absolute inset-0 bg-emerald-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
                    <div className="h-20 flex items-center justify-center">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-tr from-emerald-400/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
                    </div>
                  </div>
                </div>
              ))}
